...
export function downloadStudentResultPDF(result: ExamResult): void {
  ...
  doc.setFontSize(9);
  const note = isPass
    ? `Selamat atas pencapaian yang memuaskan. Tingkatkan terus apresiasi dan kreativitas dalam berkarya ${CONFIG.MATA_PELAJARAN}.`
    : `Perlu bimbingan dan pengulangan materi terutama pada prinsip ritme dan komposisi karya (remedial). Tetap semangat belajar.`;
