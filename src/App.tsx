 ...
 * SD Negeri 3 Loloan Timur - Jembrana - Kelas 5
 * Mata Pelajaran: Seni Rupa (Mengeksplorasi Ritme dalam Objek di Sekitar Kita, Menggambar dengan Menerapkan Prinsip Ritme)
 */
...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_seni_rupa_ritme_v1';
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan 40 soal (35 PG, 5 PGK Kategori)
